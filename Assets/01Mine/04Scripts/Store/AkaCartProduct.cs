...
public class AkaCartProduct : MonoBehaviour
{
    ...
    [SerializeField] GameObject loadign, variantTextPrefab;
    ...
    public void FillChartProduct(AkaProductToPurchaseReference reference)
    {
        ...
        StartCoroutine(AkaImageHelper.FillIconImage(iconPlace, reference.variant.image().transformedSrc(), defImageIcon, loadign));
    }
    public void Changequantity(bool plus)
    {
        ...
        AkaCart.AddOrUpdate(product, variant, quantity, false);
    }
